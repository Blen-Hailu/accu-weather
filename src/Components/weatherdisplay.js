...
import sun from '../day-pic.jpg';
import moon from '../evening-pic.jpg';
...
export const WeatherViewer = ({ cityData }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://dataservice.accuweather.com/currentconditions/v1/${cityData.Key}?apikey=1cnmbGBBHBtf9xAS0QaF0L5ImUpN9Uic`
      )
      .then((res) => {
        setData(res.data[0]);
        setLoading(false);
